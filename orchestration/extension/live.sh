...
# recipe/extension (or its legacy scripts/extension home) in a repo checkout.
VERIFY_SH=""
for _v in "$SCRIPT_DIR/verify.sh" "$SCRIPT_DIR/../../recipe/extension/verify.sh" "$SCRIPT_DIR/../../scripts/extension/verify.sh"; do
