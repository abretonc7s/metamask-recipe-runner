...
# recipe/mobile (or its legacy scripts/mobile home) in a repo checkout.
VERIFY_SH=""
for _v in "$SCRIPT_DIR/verify.sh" "$SCRIPT_DIR/../../recipe/mobile/verify.sh" "$SCRIPT_DIR/../../scripts/mobile/verify.sh"; do
